package com.example.leshidemo1.ui.utils.view;
...
public class ControlView extends View {
    ...
    private static boolean mCanDrag = false;           // 是否允许拖动
    ...
    private class OnClickListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            ...
            // 事件回调
            if (null != mOnProgressChangeListener) {
                mOnProgressChangeListener.onProgressChanged(ControlView.this, getProgress(), true);
                mOnProgressChangeListener.onStopTrackingTouch(ControlView.this);
            }
            return true;
        }
    }
    ...
    public interface OnProgressChangeListener {
         ...
         */
        void onProgressChanged(ControlView seekBar, int progress, boolean isUser);
         ...
         * @param seekBar 拖动条
         */
        void onStartTrackingTouch(ControlView seekBar);
         ...
         * @param seekBar 拖动条
         */
        void onStopTrackingTouch(ControlView seekBar);
    }
    // endregion -----------------------------------------------------------------------------------
}
