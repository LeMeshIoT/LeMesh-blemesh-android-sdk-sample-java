...
public class SpreadView extends View {
    ...
    public SpreadView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        radius = 30;
        maxRadius = 60;
        int centerColor = a.getColor(R.styleable.SpreadView_spread_center_color, ContextCompat.getColor(context, R.color.spread_color1));
        int spreadColor = a.getColor(R.styleable.SpreadView_spread_spread_color, ContextCompat.getColor(context, R.color.spread_color2));
